...
public class Controleur extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if ((session.getAttribute("sessionOn") != null) && ((boolean)session.getAttribute("sessionOn") != false)) {
			boolean sessionOn = (boolean) session.getAttribute("sessionOn");
			System.out.println("sessionOn="+sessionOn);
			if ((session != null) && sessionOn==true) {
...
//Cas de covid		
		...
		case "CasToAdd":
			...
			if (nom_complet.equals("") || telephone.equals("") || adresse.equals("") || code_postal.equals("")
					|| etat.equals(""))
